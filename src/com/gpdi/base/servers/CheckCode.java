...
public class CheckCode {  
    ...
    public static void main(String[] ages){
        ...
        //checkCode.drawDisturbLine(checkCode.getBuffImg().createGraphics()) ;
        //checkCode.setBuffImg(checkCode.disturb());  
        checkCode.createImgFile("E:\\testImg.jpg") ;
    } 
    ...
    private BufferedImage twistImage() {  
        ...
        //destBi.createGraphics().setColor()
...
//                int nOldY = j; 
                ...
                int nOldX = i ;  
                int nOldY = getYPosition4Twist(dPhase, dMultValue,  
                		destBi.getWidth(), i, j);  
    ...
    private int getXPosition4Twist(double dPhase, double dMultValue,  
        ...
        double PI = 13.1415926535897932384626433832799; // 此值越大，扭曲程度越大  
    ...
    private int getYPosition4Twist(double dPhase, double dMultValue,  
    		int width, int xPosition, int yPosition) {  
    	double PI = 13.1415926535897932384626433832799; // 此值越大，扭曲程度越大  
    	double dy = (double) (PI * xPosition) / width + dPhase;  
    	double dx = Math.sin(dy); 
    	
    	return yPosition + (int) (dx * dMultValue);  
    }  
